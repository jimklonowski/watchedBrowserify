...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "sweetalert2"], factory);
    }
    ...
    (function (Dashboard) {
        ...
        function doDraggabilly(selector) {
        ...
        Dashboard.doDraggabilly = doDraggabilly;
        function doPackery() {
            var grid = document.querySelector('#grid');
            var p = new Packery('#grid', { itemSelector: '.widget', gutter: 10, stagger: 300 });
            p.layout();
        }
        Dashboard.doPackery = doPackery;
        function logOrder() {
            var $widgets = $('.widget');
        }
        Dashboard.logOrder = logOrder;
...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./dashboard"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
